            ...
            <LemonTable<DataDeletionRequest>
                ...
                expandable={{
                    expandedRowRender: (row) => (
                        <div className="flex flex-col gap-1 p-2 text-sm">
                            <div>
                                <b>Time range:</b> <TZLabel time={row.start_time} /> &rarr;{' '}
                                <TZLabel time={row.end_time} />
                            </div>
                            {row.events.length > 0 && (
                                <div>
                            ...
                            {row.count !== null && (
                                <div>
                                    <b>Matched events at submit time:</b> {row.count.toLocaleString()}
                                </div>
                            )}
                        </div>
                    ),
                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        render: (value) => <TZLabel time={value as string} />,
                    },
                    {
                        title: 'By',
